...
RELEASE_YEAR_PATTERNS = [
    re.compile(r'[.\s\(\)\[\]](19[0-9]{2}|20[0-9]{2})(?=[.\s\(\)\[\]](BluRay|BDRip|BRRip|DVDRip|WEBRip|WEB-DL|HDRip|Directors|Cut|Extended|Unrated|DC|REMASTERED|REMUX|REPACK|PROPER|REAL))', re.IGNORECASE),
